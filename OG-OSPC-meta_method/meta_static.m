...
%% read  2 images 
image1=imread('C:\Users\User\Desktop\AUB\spring 2022\dataset\calib_narrowGamma_sweep3\00400.jpg ');
image2=imread('C:\Users\User\Desktop\AUB\spring 2022\dataset\calib_narrowGamma_sweep3\00920.jpg ');
%% 800-890 900-990
%% normalize images
...
image1_exposure=exposures(400 + 1);
image2_exposure=exposures(920 + 1);
...
%A=(zeros(size(image1_flat,1)*size(image1_flat,2),11)); % 11 unknowns
