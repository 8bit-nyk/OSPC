function [I1]=avg_two_frames(I1,I2)
%         clc
%         clear all
%         I1=imread("C:\Users\User\Desktop\AUB\spring 2022\dataset\sequence_30\images\000" + 35 + ".jpg");
%         I2=imread("C:\Users\User\Desktop\AUB\spring 2022\dataset\sequence_30\images\000" + 36 + ".jpg");
%    
        % orb
